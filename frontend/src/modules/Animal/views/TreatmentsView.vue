...
<template>
  <main class="flex flex-col">
    ...
    <BottomDrawer class="bg-base-200" size="big" v-model="newTreatmentOpen" v-slot="{ close }">
      <div class="flex h-full flex-col gap-5">
        ...
        >
          ...
          <div class="flex flex-col gap-2">
            <label class="font-semibold" for="new-treatment-quantity"> Cantidad a aplicar </label>
            <TextInput
